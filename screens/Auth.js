...
import RegistrationTypeScreen from "../components/Auth/RegistrationTypeScreen";
...
const Auth = () => {
  ...
  const renderAuthScreen = () => {
    switch (authType) {
      ...
      case "select":
        return <RegistrationTypeScreen setAuthType={setAuthType} />;
      case "signup":
        return <RidersignUp setAuthType={setAuthType} />;
      case "signin":
